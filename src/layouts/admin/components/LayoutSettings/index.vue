<template>
  <a-drawer v-model:open="visible" title="布局设置" placement="right" :width="360" :body-style="{ padding: '16px' }">
    <div class="settings-content">
      ...
      <div class="setting-item">
        <div class="setting-title">过渡动画</div>
        <a-segmented
          v-model:value="appStore.transitionName"
          :options="[
      ...
      <div class="setting-item">
        ...
        <a-segmented
          v-model:value="appStore.contentWidthMode"
          :options="[
